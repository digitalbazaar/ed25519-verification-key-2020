...
/**
 * Takes a Buffer of public key bytes and encodes it in DER-encoded
...
const api = {
  /**
   * Generates a key using a 32 bit Uint8Array.
   *
   * @param {Uint8Array} seedBytes - The bytes for the private key.
   *
   * @returns {object} The buffer for the public and private key material.
  */
  ...
  async generateKeyPair() {
    return api.generateKeyPairFromSeed(randomBytes(32));
  },
